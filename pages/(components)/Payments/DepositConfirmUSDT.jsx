...
const DepositConfirmUSDT = ({ setMode, mode }) => {
  ...
  return (
    <div className={`deposit ${mode === "finishUSDT" ? "block" : "hidden"}`}>
        ...
        <div className="overflow_control height border border-solid border-[#11279d] rounded-lg mt-8 p-4">
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 capitalize">
              ...
              <p className="text-[#3b82f6] text-sm font-Playfair">
            ...
            <div className="flex gap-3 mt-4">
              <button
                ...
                onClick={() => setMode("payUSDT")}
              >
                Back
              </button>
              <button
                className="cmn-btn w-fit"
                onClick={() => setMode("payment-USDT")}
              >
                Send
              </button>
            </div>
...
export default DepositConfirmUSDT;
