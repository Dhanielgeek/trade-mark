...
import { EthAddress } from "@/Adresses";
import { EthQrCode } from "@/assets";
import Image from "next/image";

const MakePaymentUSDT = ({ setMode, mode }) => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      const storedAmount = localStorage.getItem("depositAmountUSDT") || "";
  ...
  return (
    <div className={`deposit ${mode === "payment-USDT" ? "block" : "hidden"}`}>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 capitalize">
              ...
              <p className="text-[#3b82f6] font-Playfair">
                ...
                Only send ETH assets to this address. Other assets will be lost
                forever.
              </p>
              <div className="flex gap-2 justify-between py-3">
                <span className="text-[#3b82f6] font-Playfair">Pay ETH</span>
              ...
              <div className="flex flex-col gap-3 py-3">
                <div className="flex gap-2 justify-between">
                  ...
                  <button className="py-1 px-7 bg-blue-500 text-white rounded">
                    copy <CopyToClipboardButton address={EthAddress} />
                  </button>
                </div>
                <div className="flex justify-center py-2">
                  <Image src={EthQrCode} alt="Eth QR Code" />
                </div>
              </div>
            </div>
            <div className="flex gap-3 mt-4">
              <button
                ...
                onClick={() => setMode("finishUSDT")}
              >
                Back
              </button>
              <button className="cmn-btn w-fit" onClick={handlePaidUSDT}>
                {loading ? (
                  <span>
...
export default MakePaymentUSDT;
