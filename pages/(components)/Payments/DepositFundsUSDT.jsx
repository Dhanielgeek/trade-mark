...
const DepositFundsUSDT = ({ setMode, mode }) => {
  const [amount, setAmount] = useState("");

  useEffect(() => {
    const savedAmount = localStorage.getItem("depositAmountUSDT");
    if (savedAmount) {
  ...
  const changeHandler = (value) => {
    ...
    localStorage.setItem("depositAmountUSDT", value);
  };

  return (
    <div className={`deposit ${mode === "payUSDT" ? "block" : "hidden"}`}>
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 capitalize">
              <p className="text-base font-light">
                Make the payment directly into the ETH wallet
              </p>
...
export default DepositFundsUSDT;
