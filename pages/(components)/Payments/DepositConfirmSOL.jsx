...
const DepositConfirmSOL = ({ setMode, mode }) => {
  ...
  return (
    <div className={`deposit ${mode === "finishSOL" ? "block" : "hidden"}`}>
          ...
          <div className="grid gap-4">
            ...
            <div className="flex gap-3 mt-4">
              <button
                ...
                onClick={() => setMode("paySOL")}
              >
                Back
              </button>
              <button
                className="cmn-btn w-fit"
                onClick={() => setMode("payment-SOL")}
              >
                Send
              </button>
            </div>
...
export default DepositConfirmSOL;
