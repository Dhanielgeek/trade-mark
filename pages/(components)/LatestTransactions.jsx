...
function generateRandomNamesAndAmounts(type) {
  const data = [];

  for (let i = 0; i < 5; i++) {
    const givenName = `${
      fakeNames[getRandomInt(0, fakeNames.length - 1)].GivenName
    } ${fakeNames[getRandomInt(0, fakeNames.length - 1)].Surname}`;
    let amount = 0;
    ...
    data.push({ name: givenName, amount });
  }
...
const LatestTransactions = () => {
  ...
  useEffect(() => {
    setLatestDeposits(generateRandomNamesAndAmounts("deposit"));
    setLatestWithdraws(generateRandomNamesAndAmounts("withdraw"));
  }, []);
    ...
    <>
      <section className="py-10 w-[100%]">
        <div
          ...
          className="main_container grid gap-10"
        >
          <h3
            data-aos="fade-up"
            data-aos-delay="100"
          ...
          <div className="flex flex-wrap justify-center items-center gap-[3rem] lg:gap-[2rem] capitalize">
            <div className="latest_table white_bg shadow_main max-w-[42rem] w-[98%]">
              <div className="table_headers btn_bg text-white font-semibold text-[1.2rem] md:text-[2rem] p-[1rem]">
                <h5>Latest Deposits</h5>
              </div>
              <div className="p-[0.2rem] w-[100%] overflow-x-hidden">
                <table className="w-full">
                  <tbody className="w-[100%]">
                    {latestDeposits.map((item, index) => (
                      <tr
                        className="max-md:table-row flex text-[0.6rem] md:text-[1rem] w-[100%] p-4 shadow_main justify-start items-center h-[4rem] gap-[1rem] md:gap-[5rem]"
                        key={index}
                      >
                        <td className="w-[12rem] px-[0.5rem]">{item.name}</td>
                        <td className="w-[12rem]">{getFormattedDate()}</td>
                        <td className="px-[0.5rem] font-semibold">
            ...
            <div className="latest_table white_bg shadow_main max-w-[42rem] w-[98%]">
              <div className="table_headers bg-green-400 text-white font-semibold text-[1.2rem] md:text-[2rem] p-[1rem]">
                <h5>Latest Withdrawals</h5>
              </div>
              <div className="p-[0.2rem] w-[100%] overflow-x-hidden">
                <table className="w-full">
                  <tbody className="w-[100%]">
                    {latestWithdraws.map((item, index) => (
                      <tr
                        className="max-md:table-row flex  text-[0.6rem] md:text-[1rem] w-[100%] p-4 shadow_main justify-start items-center h-[4rem] gap-[1rem] md:gap-[5rem]"
                        key={index}
                      >
                        <td className="w-[12rem] px-[0.5rem]">{item.name}</td>
                        <td className="w-[12rem]">{getFormattedDate()}</td>
                        <td className="px-[0.5rem] text-green-400 font-semibold">
                          {formatCurrency(item.amount)}
                        </td>
                      </tr>
                    ))}
